...
local themeStyles = {
 ...
 Minecraft = {
        SchemeColor = Color3.fromRGB(0, 188, 59),
        Background = Color3.fromRGB(31, 20, 10),
        Header = Color3.fromRGB(50, 30, 90),
        TextColor = Color3.fromRGB(55,255,80),
        ElementColor = Color3.fromRGB(28, 30, 31)
    }
}
